...
def setWaypointConnection():
    d1 = KnowledgeUpdateServiceArrayRequest()
    d1.update_type = [0,]
    k1 = KnowledgeItem()
    k1.knowledge_type = 1
    k1.instance_type = ''
    k1.instance_name = ''
    k1.attribute_name = 'connected'
    v1 = KeyValue()
    v1.key = 'wp'
    v1.value = 'home'    # to visit place
    k1.values.append(v1)
    v2 = KeyValue()
    v2.key = 'wp'
    v2.value = 'wp2'    # to visit place
    k1.values.append(v2)
    k1.function_value = 0.0
    d1.knowledge.append(k1)
    ...
    #k1.instance_type = ''
    #k1.instance_name = ''
    k1.attribute_name = 'distance'
    #k1.values.append(v1)
    #k1.values.append(v2)
    #k1.function_value = 0.0
    d2.knowledge.append(k1)
...
def newPlan(req):
    print("Service was called to visit following waypoints: %s " %(req.path))
    addInstance()
