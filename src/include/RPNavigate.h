...
#include <navigation_2d_spot/NavigateToGoalAction.h>
...
namespace KCL_rosplan {
    ...
    class RPNavigate: public RPActionInterface
    {
      ...
      public:
         ...
         * @brief constructor
         */
        RPNavigate(std::string &actionserver);
      ...
      private:
        ...
        actionlib::SimpleActionClient<navigation_2d_spot::NavigateToGoalAction> action_client_;
